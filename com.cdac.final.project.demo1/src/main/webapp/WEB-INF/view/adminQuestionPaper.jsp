...
<html>
<head>
	<title>CDAC App | Admin | Question Paper</title>
...
<body class="body">
    ...
    <section class="mt-4 mx-5">
        <div class="container-fluid" style="display: flex;justify-content: center;">
            <div class="row row1">
                ...
                <h4 style=" color: rgb(65, 105, 225);text-align: center;">Upload Question Paper</h4>
                <div style="display: flex;justify-content: center;">
                    <form>
                        <div class="form-row">
                            <div style="width: 100%;"> 
                                <input id="subject" type="text" placeholder="Subject Name"class="form-control my-3 p-4"> 
                                <p id="validSubjectQuestionMsg" style="color: red; font-size: 11px; margin-top: -15px; margin-left: -10px"></p>
                            </div>    
                        </div>
                        <div class="form-row">
                            <div style="width: 100%;margin-top:30px"> 
                                <input id="question_ppr" type="text" placeholder="Question Paper File Path"class="form-control my-3 p-4" style="color:gray"> 
                                <p id="validQuestionFileMsg" style="color: red; font-size: 11px; margin-top: -15px; margin-left: -120px"></p>
                            </div>    
                        </div>
                        <div class="form-row">
                            <div style="width: 100%;"> 
                                <button id="question_ppr_upload" type="button" class="btn1 mt-3 mb-5">Upload</button> 
                            </div>    
                        </div>
    ...
    <footer class="text-center text-lg-start bg-light text-muted" style="margin-top: 29.4vh;">
